...
namespace QLLV01
{
    public partial class FDangKyLuanVan : Form
    {
        ...
        private void FDangKyLuanVan_Load(object sender, EventArgs e)
        {
            ...
            guna2DataGridView1.Rows[0].Cells[5].Value = "5";
            ...
            guna2DataGridView1.Rows[1].Cells[5].Value = "6";
            ...
            guna2DataGridView1.Rows[2].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[3].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[4].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[5].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[6].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[7].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[8].Cells[5].Value = "123";
            ...
            guna2DataGridView1.Rows[9].Cells[5].Value = "123";
            guna2DataGridView1.Rows[9].Cells[0].Value = "123";
        }
